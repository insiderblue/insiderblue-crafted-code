...
const perks = [
  { icon: Zap, text: "Resposta em até 2h" },
  { icon: ShieldCheck, text: "Proposta sem compromisso" },
      ...
      <div className="container relative z-10">
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-10 py-4 text-sm font-semibold rounded-lg bg-accent text-accent-foreground hover:bg-accent/90 active:scale-[0.97] transition-all mb-10"
          >
