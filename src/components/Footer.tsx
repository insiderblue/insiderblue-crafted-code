    ...
    <footer className="bg-navy-deep border-t border-primary-foreground/5">
      <div className="container py-16">
        <div className="grid md:grid-cols-3 gap-12">
          {/* Brand */}
          <div>
            <span className="text-lg font-bold text-primary-foreground tracking-tight block mb-3">
              insider<span className="text-accent">blue</span>
            </span>
            <p className="text-sm text-primary-foreground/40 leading-relaxed max-w-xs">
              Software personalizado que se encaixa perfeitamente na operação do seu negócio.
            </p>
          </div>
